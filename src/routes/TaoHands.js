...
export default class TaoHands extends Component {
	constructor(props) {
		super(props);
	...
	render({ url }, { open }) {
		...
		return (
			<div>
				...
				<p style={pLarge}>Come to our FREE evening session and experience what Tao Hands can do for you.</p>
				<figure>
				...
				<div style={gridS2}>
					<div style={s2title}>
						<h2 style={headline}>Would you like to experience the power of Tao Hands on Sat. June 22 in San Francisco?</h2>
					</div>
					<div style={s2right}>
						<img src="./image/TaoHands2.jpg" alt="Tao Hands Prctitioners 2" style="width: 300px; float:right" />
					</div>
					<div style={s2left}>
				...
				<h2 style="text-align:center; font-size: 1.8em">Have you been searching for a better solution and you have tried many therapies or 
					treatments. But you are still struggling? Come and listen to how other people also 
